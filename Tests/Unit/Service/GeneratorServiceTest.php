<?php
namespace Codeminds\FlowKickstarter\Tests\Unit\Service;
...
class GeneratorServiceTest extends \Neos\Flow\Tests\UnitTestCase
{
    ...
    {
        $service = $this->getAccessibleMock(\Codeminds\FlowKickstarter\Service\GeneratorService::class, array('dummy'));
